...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UnitedGeoNameSynonim.synonim_name'
        db.add_column('united_geonames_unitedgeonamesynonim', 'synonim_name', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UnitedGeoNameSynonim.synonim_name'
        db.delete_column('united_geonames_unitedgeonamesynonim', 'synonim_name')
