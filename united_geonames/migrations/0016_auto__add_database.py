...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('united_geonames_database', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('information', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('united_geonames', ['Database'])


    def backwards(self, orm):
        
        # Deleting model 'Database'
        db.delete_table('united_geonames_database')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 19, 18, 5, 46, 784703)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 19, 18, 5, 46, 784611)'}),
