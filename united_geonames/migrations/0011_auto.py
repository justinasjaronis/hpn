...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field display_for_users on 'GeoNamesMatchingLogMatch'
        db.create_table('united_geonames_geonamesmatchinglogmatch_display_for_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('geonamesmatchinglogmatch', models.ForeignKey(orm['united_geonames.geonamesmatchinglogmatch'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('united_geonames_geonamesmatchinglogmatch_display_for_users', ['geonamesmatchinglogmatch_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field display_for_users on 'GeoNamesMatchingLogMatch'
        db.delete_table('united_geonames_geonamesmatchinglogmatch_display_for_users')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 11, 38, 29, 144543)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 11, 38, 29, 144455)'}),
