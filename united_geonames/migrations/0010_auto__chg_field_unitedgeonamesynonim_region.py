...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnitedGeoNameSynonim.region'
        db.alter_column('united_geonames_unitedgeonamesynonim', 'region', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'UnitedGeoNameSynonim.region'
        db.alter_column('united_geonames_unitedgeonamesynonim', 'region', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
