...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('united_geonames_unitedgeonamesynonim', 'region', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)

        # Adding field 'UnitedGeoNameSynonim.subregion'
        db.add_column('united_geonames_unitedgeonamesynonim', 'subregion', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)
    ...
    models = {
        ...
        'united_geonames.unitedgeonamesynonim': {
            ...
            'subregion': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
