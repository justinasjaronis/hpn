...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserGeoName'
        db.create_table('united_geonames_usergeoname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('subregion', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('coordinates', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, spatial_index=False)),
        ))
        db.send_create_signal('united_geonames', ['UserGeoName'])


    def backwards(self, orm):
        
        # Deleting model 'UserGeoName'
        db.delete_table('united_geonames_usergeoname')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 11, 13, 42, 58, 891099)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 11, 13, 42, 58, 891008)'}),
