...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field temporal on 'UnitedGeoNameSynonim'
        db.create_table('united_geonames_unitedgeonamesynonim_temporal', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unitedgeonamesynonim', models.ForeignKey(orm['united_geonames.unitedgeonamesynonim'], null=False)),
            ('advanceddate', models.ForeignKey(orm['advanceddate.advanceddate'], null=False))
        ))
        db.create_unique('united_geonames_unitedgeonamesynonim_temporal', ['unitedgeonamesynonim_id', 'advanceddate_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field temporal on 'UnitedGeoNameSynonim'
        db.delete_table('united_geonames_unitedgeonamesynonim_temporal')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 7, 50, 33, 183383)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 7, 50, 33, 183279)'}),
        ...
        'united_geonames.unitedgeonamesynonim': {
            ...
            'temporal': ('advanceddate.fields.AdvancedDateField', [], {'to': "orm['advanceddate.AdvancedDate']", 'symmetrical': 'False'}),
