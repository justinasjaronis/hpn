...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoNamesMatchingLogMatch.number_of_alternatives'
        db.add_column('united_geonames_geonamesmatchinglogmatch', 'number_of_alternatives', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'GeoNamesMatchingLogMatch.matching_index'
        db.add_column('united_geonames_geonamesmatchinglogmatch', 'matching_index', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Changing field 'GeoNamesMatchingLogMatch.start_date'
        db.alter_column('united_geonames_geonamesmatchinglogmatch', 'start_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'GeoNamesMatchingLogMatch.number_of_alternatives'
        db.delete_column('united_geonames_geonamesmatchinglogmatch', 'number_of_alternatives')

        # Deleting field 'GeoNamesMatchingLogMatch.matching_index'
        db.delete_column('united_geonames_geonamesmatchinglogmatch', 'matching_index')

        # Changing field 'GeoNamesMatchingLogMatch.start_date'
        db.alter_column('united_geonames_geonamesmatchinglogmatch', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
