...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserGeoName.language'
        db.add_column('united_geonames_usergeoname', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserGeoName.language'
        db.delete_column('united_geonames_usergeoname', 'language')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 13, 17, 39, 690014)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 13, 17, 39, 689889)'}),
        ...
        'united_geonames.unitedgeonamesynonim': {
            ...
            'temporal': ('advanceddate.fields.AdvancedDateField', [], {'blank': 'True', 'related_name': "'temporal'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['advanceddate.AdvancedDate']"}),
        ...
        'united_geonames.usergeoname': {
            ...
            'temporal': ('advanceddate.fields.AdvancedDateField', [], {'blank': 'True', 'related_name': "'user_geonames'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['advanceddate.AdvancedDate']"}),
