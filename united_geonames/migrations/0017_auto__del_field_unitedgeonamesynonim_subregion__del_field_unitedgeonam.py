...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UnitedGeoNameSynonim.subregion'
        db.delete_column('united_geonames_unitedgeonamesynonim', 'subregion')

        # Deleting field 'UnitedGeoNameSynonim.region'
        db.delete_column('united_geonames_unitedgeonamesynonim', 'region')

        # Adding field 'UserGeoName.country'
        db.add_column('united_geonames_usergeoname', 'country', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'Database.email'
        db.add_column('united_geonames_database', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Deleting field 'GeoNamesMatchingLogMatch.name'
        db.delete_column('united_geonames_geonamesmatchinglogmatch', 'name')

        # Adding field 'UnitedGeoName.region'
        db.add_column('united_geonames_unitedgeoname', 'region', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'UnitedGeoName.subregion'
        db.add_column('united_geonames_unitedgeoname', 'subregion', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'UnitedGeoName.country'
        db.add_column('united_geonames_unitedgeoname', 'country', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'UnitedGeoName.centroid'
        db.add_column('united_geonames_unitedgeoname', 'centroid', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, spatial_index=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UnitedGeoNameSynonim.subregion'
        db.add_column('united_geonames_unitedgeonamesynonim', 'subregion', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'UnitedGeoNameSynonim.region'
        db.add_column('united_geonames_unitedgeonamesynonim', 'region', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Deleting field 'UserGeoName.country'
        db.delete_column('united_geonames_usergeoname', 'country')

        # Deleting field 'Database.email'
        db.delete_column('united_geonames_database', 'email')

        # Adding field 'GeoNamesMatchingLogMatch.name'
        db.add_column('united_geonames_geonamesmatchinglogmatch', 'name', self.gf('django.db.models.fields.CharField')(max_length=233, null=True, blank=True), keep_default=False)

        # Deleting field 'UnitedGeoName.region'
        db.delete_column('united_geonames_unitedgeoname', 'region')

        # Deleting field 'UnitedGeoName.subregion'
        db.delete_column('united_geonames_unitedgeoname', 'subregion')

        # Deleting field 'UnitedGeoName.country'
        db.delete_column('united_geonames_unitedgeoname', 'country')

        # Deleting field 'UnitedGeoName.centroid'
        db.delete_column('united_geonames_unitedgeoname', 'centroid')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 2, 11, 23, 36, 376267)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 2, 11, 23, 36, 376169)'}),
